...
export const portfolioItems = [
  ...
  },
  {
    ...
    result: "Rebranded Instagram — 18% monthly follower growth.",
    type: "Social + Content",
  ...
  },
  {
    ...
    niche: "Technology",
    result: "LinkedIn content strategy — 3x B2B inbound enquiries.",
...
export const processSteps = [
  {
    ...
    description: "Complete our structured intake form with your business info, goals, brand and content. Takes 10–15 minutes.",
  },
  {
    step: "02",
